# raymond [![Build Status](https://secure.travis-ci.org/jumba-nl/raymond.svg?branch=master)](http://travis-ci.org/jumba-nl/raymond) [![GoDoc](https://godoc.org/github.com/jumba-nl/raymond?status.svg)](http://godoc.org/github.com/jumba-nl/raymond)

Handlebars for [golang](https://golang.org) with the same features as [handlebars.js](http://handlebarsjs.com) `3.0`.

The full API documentation is available here: <http://godoc.org/github.com/jumba-nl/raymond>.

![Raymond Logo](https://github.com/jumba-nl/raymond/blob/master/raymond.png?raw=true "Raymond")
...
## Quick Start
    ...
    $ go get github.com/jumba-nl/raymond
...
```html
<a href='http://www.jumba-nl.com/'>This is a &lt;em&gt;cool&lt;/em&gt; website</a>
```
...
import (
    ...
    "github.com/jumba-nl/raymond/lexer"
)
...
import (
    ...
    "github.com/jumba-nl/raymond/ast"
    "github.com/jumba-nl/raymond/parser"
)
